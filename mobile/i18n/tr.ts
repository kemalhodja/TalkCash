export default {
  ...
  assistant: {
    ...
    googleStep1: "1. Google uygulaması → Asistan → Rutinler",
    googleStep2: "2. \"Uygulama aç\" + TalkCash URL'si ekleyin",
    googleStep3: "3. Ana ekranda uzun basın → TalkCash kısayolları (Android)",
