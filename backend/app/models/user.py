...
class User(Base):
    ...
    micro_savings_prefs: Mapped[str | None] = mapped_column(String(2000), nullable=True)
    assistant_persona: Mapped[str] = mapped_column(String(32), default="default")
    ...
    product_rules = relationship("UserProductRule", back_populates="user")
    suggestion_logs = relationship("ShoppingSuggestionLog", back_populates="user")
    product_history = relationship("ProductHistory", back_populates="user")
