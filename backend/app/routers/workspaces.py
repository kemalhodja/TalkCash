...
from app.schemas.workspace import InvitationResponse, WorkspaceCreate, WorkspaceInvite, WorkspaceResponse
...
async def invite_workspace_member(
    ...
    try:
        ...
        return InvitationResponse(
            id=invite.id, email=invite.email, role=invite.role, status=invite.status, created_at=invite.created_at,
        )
    except Exception as exc:
